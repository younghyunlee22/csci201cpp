...
{
  string result = getName() + " the Fighter stats:\n";
  result += Character::tostring(); // call tostring() from base class
  return result;
}
...
{
  string result = getName() + " the Rogue stats:\n";
  result += Character::tostring(); // call tostring() from base class
  return result;
}
...
string Magician::tostring()
{
  string result = getName() + " the Magician stats:\n";
  result += Character::tostring(); // call tostring() from base class
  return result;
}
...
string Cleric::tostring()
{
  string result = getName() + " the Cleric stats:\n";
  result += Character::tostring(); // call tostring() from base class
  return result;
}
